...
VALUES (NULL, '82198127000121', CURRENT_DATE(), CURRENT_DATE(), 'Fiap IT');
...
VALUES (NULL, '81378394100', CURRENT_DATE(), CURRENT_DATE(), 'admin@mail.com', 'ADMIN', 'ROLE_ADMIN', NULL, NULL, 
